...
public class Mall2 extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        horizontalProductScrollModelList.add(new HorizontalProductScrollModel(R.drawable.jacket, "Áo khoác nâu", "Đồ quá đẹp", "100000"));
