...
public class Mall1 extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        horizontalProductScrollModelList.add(new HorizontalProductScrollModel(R.drawable.jacket, "Đồ nữ", "Đồ quá đẹp", "300000"));
        horizontalProductScrollModelList.add(new HorizontalProductScrollModel(R.drawable.bs3, "Set nữ đẹp", "Đồ quá đẹp", "400000"));
        horizontalProductScrollModelList.add(new HorizontalProductScrollModel(R.drawable.bodysuit, "Áo khoác nâu", "Đồ quá đẹp", "100000"));
