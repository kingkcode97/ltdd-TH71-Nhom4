...
import com.example.fashionshop.tasks.GetAllVariantsByProductIdTask;
import com.example.fashionshop.tasks.UpdateCartItemTask;
import com.example.fashionshop.utils.Communicator;
import com.example.fashionshop.utils.LinkedMap;
...
public class CartUpdateDialog extends DialogFragment implements View.OnClickListener {
    ...
    Variants variantRec;
    Map<String, Boolean> variantMap = new LinkedMap<>();
